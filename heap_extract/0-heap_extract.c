...
/**
 * checkHeight - check size of tree
 * @tree: Pointer node to get height
 *
...
/**
 * preorderTraversal - preorder traversal the tree
 *
 * @root: root pointer
 * @node: node pointer
 * @h: height
...
/**
 * heap_extract - exctract heap
 * @root: double pointer of root
 * Return: return the node or 0.
 */
